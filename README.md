...
WAŻNE: Zaleca się, aby nie używać tych samych pinów I2C, co dla modułu zegara RTC (jeżeli ktoś go wykorzytuje), w celu uniknięcia zakłóceń. Ten mod korzysta z magistrali Wire(1), podczas gdy RTC w yoRadio korzysta z Wire(0).

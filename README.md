...
<br><br>IMPORTANT: It is recommended not to use the same I2C pins as for RTC to avoid any interference; this mod uses Wire1 (while the yoRadio RTC uses Wire(0)).

...
<br><br>IMPORTANT: It is recommended not to use the same I2C pins as for RTC to avoid any interference; this mod uses Wire(1) (while the yoRadio RTC uses Wire(0)).
...
WAŻNE: Zaleca się, aby nie używać tych samych pinów I2C, co dla modułu RTC, w celu uniknięcia zakłóceń. Ten mod korzysta z magistrali Wire(1), podczas gdy RTC w yoRadio korzysta z Wire(0).
